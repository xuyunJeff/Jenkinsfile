...
//     		string(name:'port', defaultValue: '8761', description: '部署镜像端口')
        ...
        stages {
            ...
            stage("checkout branches") {
                steps {
                     checkout([$class: 'GitSCM', branches: [[name: '*/main']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'xuyunJeff', url: 'https://github.com/xuyunJeff/Jenkinsfile.git']]])
                }
            }
